...
export const gatePassesApi = {
  ...
  getProcurementPending: async () => apiClient.get('/gate-passes/procurement/pending'),
  ...
  procurementAction: async (id, data) => apiClient.put(`/gate-passes/${id}/procurement-action`, data),
